...
<body>
	...
	<div class="right-body">
		...
		<div class="main-body">
          ...
          <table class="table table-hover table-striped" style="width:85%;margin: auto;">
             <tr>
               <td></td>
                <td>ID</td>
                 <td>姓名</td>
             ...
             <c:forEach items="${clientList}" var="client">
               <tr>
                <td><input type="checkbox" name="checkId" class="boxdelete" value="${client.id}"/> </td>
                <td>${client.id}</td>
                 <td>${client.name}</td>
                  <td>${client.sex}</td>
                   <td>${client.phone}</td>
                   <td>${client.address}</td>
                    <td>${client.age}</td>
                    <td>
                       <a href="lookClientInfo.action?id=${client.id}" style="color:#535ba0;">查 看</a>
                    </td>
               <tr>
              ...
              <tr>
                 <td>
                    <a class="btn btn-danger" onclick="deleteMore();">批量删除</a>
                 </td>
