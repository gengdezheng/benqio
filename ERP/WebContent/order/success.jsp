...
<body>
	...
	<div class="right-body">
		...
		<div class="main-body">
			...
			<div
				style="width: 300px; height: 300px; margin: auto; margin-top: 10%; text-align: center;">
				<img alt="" src="imgs/success.png"><br>
				<br>
				<br> <strong> 操作成功！ </strong><br>
				<br>
				<br>
				<a href="index.action" class="btn btn-success" style="width: 50%;">返 回</a>
			</div>
		</div>
	</div>
