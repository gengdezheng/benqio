...
<div class="new_body">
    ...
    <div class="new_body_center">
        ...
        <%
            PageInfo<Article> articleList = (PageInfo<Article>) session.getAttribute("today");
       ...
       <div class="pageH" style="width: 100%;height: 50px;text-align: center;">
           <%
              if(!articleList.isIsFirstPage()){
                  out.print("<a href='/lookToday?pageNum="+(articleList.getPageNum()-1)+"' style='margin-right:20px;border-radius:0px;' class='btn btn-primary'>上一页</a>");
               }
              else{
                  out.print("<a href='' class='btn disabled' style='margin-right:20px;border-radius:0px;'>上一页</a>");
              }
              if(!articleList.isIsLastPage()){
                  out.print("<a href='/lookToday?pageNum="+(articleList.getPageNum()+1)+"' style='margin-left:20px;border-radius:0px;' class='btn btn-primary'>下一页</a>");
              }
              else{
