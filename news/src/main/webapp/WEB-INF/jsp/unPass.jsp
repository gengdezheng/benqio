        ...
        <div class="article-body">
            <table class="table table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <c:forEach var="list" items="${unPassList}">
                      <tr>
                      <td style="width:150px;text-overflow :ellipsis; white-space :nowrap;overflow : hidden; ">${list.articleId}</td>
                      <td>${list.title}</td>
                      <td style="width:150px;text-overflow :ellipsis; white-space :nowrap;overflow : hidden; ">${list.content}</td>
                      <td>${list.time}</td>
                      <td style="color: #843534;">待审核</td>
                      </tr>
                  </c:forEach>
            </table>
        </div>
